...
export const GlobalActivityFeed = ({ logs }: GlobalActivityFeedProps) => {
  ...
  return (
    <div className="flex flex-col h-full bg-transparent p-0 overflow-hidden text-left">
      <div className="px-4 py-8 md:p-8 border-b border-slate-100 bg-transparent flex items-center justify-between">
        ...
        <div className="px-4 py-2 bg-slate-900 rounded-full flex items-center gap-2 shrink-0">
           <div className="w-1.5 h-1.5 bg-emerald-400 rounded-full animate-pulse" />
           <span className="text-[8px] font-black text-white uppercase tracking-widest">System Online</span>
        </div>
      </div>

      <div className="flex-1 overflow-y-auto px-4 py-8 md:p-8 space-y-4 custom-scrollbar">
